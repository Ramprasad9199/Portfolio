...
const Contact = () => {
  ...
  return (
    <section id="contact" className="contact" ref={sectionRef}>
      <div className={`contact__container ${isVisible ? "animate" : ""}`}>
        ...
        <div className="contact__links">
          ...
          >
            ...
            <div className="contact__link-content">
              ...
              <span className="contact__link-value">{contactData.email}</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="contact__link-content">
              ...
              <span className="contact__link-value">github.com/ramprasad</span>
            </div>
          </a>
          ...
          >
            ...
            <div className="contact__link-content">
              ...
              <span className="contact__link-value">linkedin.com/in/ramprasad</span>
            </div>
          </a>
        </div>
      ...
      <footer className="contact__footer">
        <p>Designed & Built by Ramprasad</p>
      </footer>
